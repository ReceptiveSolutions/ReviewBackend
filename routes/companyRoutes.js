...
//     // Basic validation
//     if (!name || !address || !business_email) {
//         return res.status(400).json({ error: "Name, address, and business email are required." });
//     }

//     try {
//         const result = await pool.query(
//             `INSERT INTO companies 
//             (name, address, website_link, google_map_link, categories, gstin_num, business_email, social_links, avg_rating, business_phone)
...
//                 gstin_num || null,
//                 business_email,
//                 social_links ? JSON.stringify(social_links) : null, // key-value JSON
//                 avg_rating || null,
//                 business_phone || null
//             ]
//         );
    ...
    try {
        ...
        if (!name || !address || !business_email || !gstin_num) {
            return res.status(400).json({
                error: "Name, address, business email, and GSTIN are required."
            });
        }
